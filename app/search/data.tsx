export const mails = [
  ...
  {
    id: "e5f6g7h8-56i5-11e6-j3k4-4l5m6n7o7890",
    name: "Michael Scott",
    email: "MISCO@orsted.com",
    subject: "Chief Technology Officer",
    text: "TechGlobal",
    read: true,
    labels: ["CTO", "MY CC Software Engineering XVI"],
    chart: [
      { month: "Exception Handling", desktop: 4 },
      { month: "Async", desktop: 3 },
      { month: "Logging", desktop: 4 },
      ...
      { month: "OOP", desktop: 3 },
      { month: "Typing", desktop: 4 },
    ],
    rating: 3.67,
    years: 2,
  },
  {
    id: "d4e5f6g7-45h4-11e5-i2j3-3k4l5mno6789",
    name: "Emily Brown",
    email: "EMBRO@orsted.com",
    subject: "Product Manager",
    text: "ManageIt",
    read: true,
    labels: ["Management", "MY CC Software Engineering XV"],
    chart: [
  ...
  {
    id: "b2c3d4e5-23f2-11e3-g9i0-1j2k3lmn4567",
    name: "Linda Black",
    email: "LIBLA@orsted.com",
    subject: "Cloud Engineer",
    text: "Cloudify",
    read: true,
    labels: ["Cloud", "MY CC Software Engineering XIII"],
    chart: [
  ...
  {
    id: "a1b2c3d4-12e1-11e2-f8h9-9j7k8mno1234",
    name: "Samuel Green",
    email: "SAGRE@orsted.com",
    subject: "Technical Writer",
    text: "TechDocs",
    read: true,
    labels: ["Documentation", "MY CC Software Engineering"],
    chart: [
      { month: "Exception Handling", desktop: 3 },
      { month: "Async", desktop: 2 },
      { month: "Logging", desktop: 3 },
